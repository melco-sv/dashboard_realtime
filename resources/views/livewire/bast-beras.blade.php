    ...
    <div class="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden mb-6">
        <div class="flex items-center justify-between px-5 py-3 border-b border-gray-800">
            ...
            <button wire:click="openModal"
                class="bg-green-600 hover:bg-green-500 text-white px-4 py-2 rounded-lg text-sm font-bold transition-colors flex items-center gap-2">
        ...
        <div class="bg-gray-900 border border-gray-700 rounded-2xl p-6 w-full max-w-lg shadow-2xl">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="nomor_surat"
                        class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 text-sm focus:border-green-500 focus:outline-none font-mono">
                </div>
                <div>
                    ...
                    <input type="text" wire:model="nama_kepala_unit" placeholder="Nama lengkap..."
                        class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 text-sm focus:border-green-500 focus:outline-none">
                </div>
                <div>
            ...
            <div class="flex gap-3 mt-6">
                <button wire:click="cetakPdf"
                    class="flex-1 bg-green-600 hover:bg-green-500 text-white font-bold py-2.5 rounded-xl text-sm text-center transition-colors">
                    Cetak PDF
                </button>
