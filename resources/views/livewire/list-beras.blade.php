<div wire:poll.30s class="min-h-screen bg-[#0b0c15] p-6 text-white font-['Space_Grotesk']">
    ...
    <div class="max-w-full mx-auto mb-6 flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-white">List Dokumen Beras (HGL)</h1>
        ...
        <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <input type="text" wire:model.live="search"
                ...
                class="bg-gray-800 border border-gray-700 text-white px-4 py-2 rounded-lg focus:outline-none focus:border-green-500 w-full sm:w-72">
            <a href="{{ route('input.beras') }}" wire:navigate
                class="bg-green-600 hover:bg-green-500 text-white px-4 py-2 rounded-lg font-bold flex items-center justify-center gap-2 shadow-lg shadow-green-500/30 whitespace-nowrap w-full sm:w-auto">
                + Input Baru
            </a>
        </div>
    </div>
            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="flex flex-col items-start gap-2 p-4 bg-gray-800/30 border-b lg:border-b-0 lg:border-r border-gray-800 w-full lg:w-auto lg:min-w-[200px] lg:max-w-[200px]">
                    ...
                    <div class="text-[10px] text-gray-500 font-bold mb-1">
                        ...
                        @elseif(isset($item->status) && $item->status == 'Reject')
                    ...
                    <div class="w-full bg-red-900/30 border border-red-600/50 rounded-lg p-2 mb-1">
                        ...
                        <p class="text-[11px] text-red-200 leading-snug break-words">{{ ($revisiNotes[$item->id_hpkk_beras] ?? $item->catatan) ?: 'Tanpa catatan.' }}</p>
                    </div>
                    @endif
