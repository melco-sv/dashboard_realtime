...
class BastGabahPdfController extends Controller
{
    use PdfLogoHelper;
    public function print(Request $request)
    {
        ...
        $totalKg = $data->sum(function ($row) {
            return (float) str_replace(',', '.', $row->jumlah_timbangan ?? 0);
        });
        ...
        return $pdf->stream("BAST-GKP-{$periode}.pdf");
    }
